    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '#ara-buton', function() {
                ...
                }).always(function(){LoaderAcik(false);});}
            });
            ...
            $(document).on('click', '.cikis-buton', function() {
                if (confirm('Gerçekten çıkış yapmak istiyor musunuz?')) {
                    LoaderAcik(true);
                    $.post("cikis.php",null,function(){document.location.href = "../index.php";}).always(function(){LoaderAcik(false);});
                }
            });
            ...
            function LoaderAcik(durum){
                if (durum) {
                    $(".loader-arka").css('display', 'block');
                }else{
                    $(".loader-arka").css('display', 'none');
                }
            }
            function kitabial() {
            ...
            <?php if ($_SESSION["kul-yetki"]=="yonetici"): ?>
			function kaydet() {
                LoaderAcik(true);
			    ...
			    $.post('kitapduzenlekaydet.php',{'d_id':id,'d_ad':ad,'d_yazar':yazar,'d_yayinevi':yayinevi,'d_sayfasayisi':sayfasayisi,'d_depodami':depodami,'d_alan':oduncalan},function(al){}).always(function(){LoaderAcik(false);});
			    soldakiler(ad);
			}
        <?php endif;?>
        </script>
    ...
    <body class="arkaplan">      
        ...
        <div class="anasayfa-conteynir" style="opacity: 0;">
            ...
            <div class="anasayfa-orta" style="opacity: 0;">
                ...
                <?php if($_SESSION["kul-yetki"]=="yonetici"){echo "<a href=\"kitapekle.php\"><div class=\"eklebuton\"></div></a>";}?>
